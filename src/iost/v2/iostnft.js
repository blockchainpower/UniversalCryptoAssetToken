...
class NFT {
    ...
    _nftUpdate() {
        ...
        var nft = {
            ...
            "CONTRACT_LOGO": "https://images-1251625178.cos.ap-guangzhou.myqcloud.com/xpet128.png"  //Project Logo
        };
    ...
    create(id, uuid, category, name, imageUrl, meta, lock, ext, level, quality, parvalue) {
        this._requireAuth();
