...
class NFT{
    ...
    _clearLog(){
        ...
        if(logInfo){
            ...
            if(timeInterval > LOG_EXPIRE_SECOND){
    ...
    _blackCheck(user){
        ...
        if(blacklist){
            ...
            if(existed == true){
                return this._msg(0,"Your account is on the blacklist and cannot be transferred");
            }
        }
    }
    ...
    _migrateCheck(id){
        ...
        if(migratelist){
            ...
            if(existed == true){
                return this._msg(0,"The asset is in the process of applying for transfer");
            }
        }
    }
